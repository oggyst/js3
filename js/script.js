...
//             }
//             intArrayAverage = intArrayAverage / intNumberOfColumns;
//             document.write('<p> '+ (i + 1) + '. column average is ' + Math.floor(intArrayAverage) + ' </p>');
//         }
//         for(var i=0; i < intNumberOfRows; i++)
//         {
//             intArrayAverage = 0;
//             for(var j=0; j < intNumberOfRows; j++)
//             {
//                 intArrayAverage = intArrayAverage + arrMatrix[j][i];
//             } 
//             document.write('<p> '+ (i + 1) + '. row average is ' + Math.floor(intArrayAverage) + ' </p>');
//         }
//     }
// }
function run(max , min) 
